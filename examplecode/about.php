      ...
      <div class="container">
        <div class="row clearfix">
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-6">
            <div class="r-welcome-msg">
              We know the difference is in the details and that’s why our car rental services, in the tourism and
              business industry, stand out for their quality and good taste Lorem ipsum dolor sit amet, consectetuer
              adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
            </div>
          </div>
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-6">
            <div class="r-video-right">
              <em>We know the difference is in the details and that’s why our car rental services, in the tourism and
                business industry, stand out for their quality and good taste.</em>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="r-insurance-part" class="r-insurance-part">
      <div class="container">
        ...
        <div class="r-insurance-btn-part">
          <a href="" title="" class="btn-primary">VIEW ALL BOATS</a>
          <a href="" title="" class="btn-default">RESERVED BOAT</a>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="r-counter-box">
              ...
              <span class="r-count-title"> BOATS IN DOCK </span>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="r-counter-box">
              ...
              <span class="r-count-title"> BOAT CENTER SOLUTIONS </span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row clearfix">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="r-driver-detail">
              <div class="r-head">Roberto Garcia <span>5 Years Experienced as Shipper</span></div>
              <div class="r-driver-text">We know the difference is in the details and that’s why our boat rental
                services, in the tourism and business industry, stand out for their quality and good taste.</div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="r-footer-block">
                ...
                <div class="r-footer-widget r-footer-nav">
                  ...
                  <nav>
                    <ul>
                      <li><a href="#">About Royal BOATS</a></li>
                      <li><a href="#">Our Mission & Strategy</a></li>
                      <li><a href="#">Our Vision</a></li>
                      <li><a href="#">Royal BOATS Advantages</a></li>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="r-footer-block">
                <div class="r-footer-widget r-footer-map">
                  <a href="#"> <img src="assets/images/icon-footer-map.png" class="icon" alt='' /> RoyalBoats on Map</a>
                </div>
                <div class="r-footer-widget r-footer-nav">
