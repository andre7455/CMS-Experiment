		...
		<div class="container">
			<div class="row clearfix">
				<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="r-logo">
						<a href="index.php" class="d-inline-block"><img src="assets/images/logo-white.png"
				...
				<div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12">
					<div class="r-header-action float-left">
						...
						if (!isset($_SESSION['userEmail'])) {
							?><a href="login-register.php"> <img src="assets/images/icon-lock.png" alt=''/> <span
										class="black">Login</span></a><?php
						} else {
							?>
							<form action="LogoutController.php" method="POST">
								<button type=submit name="logout" class="btn btn-full">Logout</button>
							</form><?php
						}
						?>
